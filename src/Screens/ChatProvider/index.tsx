...
import {TYPING_TIMEOUT_SECONDS} from 'src/Constanst/type';
import {ConversationProps, MessageProps} from 'src/Interfaces';
import {FirestoreServices} from 'src/Services/Firestore';
import {formatEncryptedMessageData, formatMessageData} from 'src/Utilities';
    ...
    const onLoadEarlier = useCallback(() => {
      if (messagesList.length < totalMessages.current && !isLoadingEarlier) {
        setTimeout(() => {
          ...
          FirestoreServicesInstance.getMoreMessage()
            .then((data: MessageProps[]) => {
